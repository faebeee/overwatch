...
var submitEvent = function (environment, apiKey, scenario, config, successful, message) {
    var data = {
    ...
    return ({
        ...
        addFail: function (scenario, config, message) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, submitEvent(environment, dataDogClientApiKey, scenario, config, false, message)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        addSuccess: function (scenario, config) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, submitEvent(environment, dataDogClientApiKey, scenario, config, true)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
