    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, config_loader_1.configLoader(testCaseFilePattern, environments, test_case_schema_1.testCaseSchema)];
            case 1:
                testCases = _a.sent();
                return [4 /*yield*/, config_loader_1.configLoader(configFilePattern, environments, project_schema_1.projectSchema)];
            case 2:
                projects = _a.sent();
                return [4 /*yield*/, test_executor_1.testExecutor(testCases, projects)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
